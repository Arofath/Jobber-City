...
class _JobFilterBottomSheetState extends State<JobFilterBottomSheet> {
  ...
  void initState() {
    ...
    // 🎯 បន្ថែមថ្មី៖ ឆែកមើលបើទិន្នន័យនៅទទេរ (ដោយសារទាញមិនបានពេលមុន Login) ត្រូវហៅ API ឡើងវិញ
    if (locationCtrl.provinces.isEmpty) {
      locationCtrl.fetchProvinces();
    }

    // 🎯 ធ្វើដូចគ្នាសម្រាប់ Category (ត្រូវប្រាកដថា CategoryController របស់អ្នកមានអនុគមន៍ឈ្មោះនេះ)
